...
public class Example_02 {
	...
	public static void main(String[] args) {
		 ...
		 * 즉) 반복되는 문장들을 묶어서 처리하면 필요할 때 마다 재 사용이 가능하며 중복코드를 제거할 수 있음
		 * 
		 * 형식
		 * 접근제한자 반환타입 메소드이름() {
		 * 	실행코드
		 ...
		 * protected : 같은 패키지에서만 접근을 허용하고 다른 패키지에서 접근하려면 해당 클래스를 상속받아야한다.
		 * private : 같은 클래스 내에서만 접근 허용. 즉, 클래스 외부에서는 접근이 불가능하다.
		 * default : 같은 패키지 내에서만 접근 가능.
		 * 
		 * private < default < protected < publi
		 */
